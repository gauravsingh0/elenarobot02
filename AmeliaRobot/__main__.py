...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/a73006f475794c33384e2.jpg), ɪᴍ Elena ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Elena*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about Elena, let us know at @yone_support_official .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
